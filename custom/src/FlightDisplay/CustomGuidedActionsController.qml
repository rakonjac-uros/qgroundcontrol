...
Item {
    ...
    readonly property string landTitle:                     qsTr("Stop")
    ...
    readonly property string changeCruiseSpeedTitle:        qsTr("Change Max Speed")
    readonly property string changeAirspeedTitle:           qsTr("Change speed")
    readonly property string orbitTitle:                    qsTr("Orbit")
    readonly property string landAbortTitle:                qsTr("Abort Stopping")
    ...
    readonly property string emergencyStopMessage:              qsTr("WARNING: THIS WILL STOP ALL MOTORS.")
    ...
    readonly property string landMessage:                       qsTr("Stop the vehicle at the current position.")
    ...
    readonly property string landAbortMessage:                  qsTr("Abort the stopping sequence.")
    ...
    readonly property string stopEngineMessage:                 qsTr("WARNING: THIS WILL STOP THE ENGINE!")
    ...
    readonly property int actionStopEngine:                 28
    ...
    function executeAction(actionCode, actionData, sliderOutputValue, optionChecked) {
        ...
        case actionSetHome:
            ...
            break
        case actionStopEngine:
            _activeVehicle.sendCommand(0, 183, true, 1, 1900, 0, 0, 0, 0, 0)
            break
        default:
